...
const ENDINGS = {
  ...
  nationalized: { kind: 'death', title: 'A Line Item Now',
    text: 'The "only if everyone does it" clause survives one press cycle. Congress nationalizes frontier labs one quarter at a time, alphabetically, and yours goes first. You keep an office. You keep a badge. You do not, in any sense that matters, keep the company.' },
  ...
  'race-to-bottom': { kind: 'judged', title: 'Moloch Wins',
    text: 'Everyone cut the same corners for the same reasons — because the other guy was about to. You lost the race AND the plot. A misaligned system is being deployed somewhere right now, and the only comfort is that it is not yours. It is not much comfort.' },
