  ...
  { id: 'funding-2027', year: 2027, title: 'The Growth-Stage Board Meeting',
    ...
    options: [
      { label: 'SPEED — the market rewards the frontier, not the footnotes', branch: 'speed',
        ...CAP_RATE_EVIDENCE,
        results: [
          { text: "You greenlight the next scale-up before the safety review of the last one is filed. The chart goes up and to the right. The safety backlog goes somewhere no chart tracks.",
            effects: { money: 1, compute: 1 } } ] },
...
const SCENARIOS = [
  ...
  { id: 'chinese-agi-surprise', year: 2026, title: 'The Six-Day Surprise',
    ...
    options: [
      ...
      { label: 'Push the team through a brutal crunch',
        ...
        results: [
          { text: 'Free food, mandatory-optional weekends, a bonus pool for anyone still standing in March. The gap closes a little. So does the team\'s goodwill, and no bonus pool reopens that.',
      ...
      { label: 'Expand hiring across every vertical at once',
        ...
        results: [
          { text: 'You triple headcount in a quarter. The org chart looks like a fractal. Rent in a two-mile radius of your office doubles, and the local news knows whose fault that is.',
      ...
      { label: 'Stand up an internal anti-distillation task force',
        ...
        results: [
          { text: 'A dedicated team hunts down unauthorized API scrapers and copycats, slowing everyone downstream of you. It is expensive, invasive, and not something you can put in a press release.',
  ...
  { id: 'podcast-tour', year: 2026, title: 'The Podcast Circuit',
    ...
    options: [
      ...
      { label: 'Ray Medhi — get personal about how you relate to your own AI',
        ...
        results: [
          { text: "You talk, unusually candidly, about texting the model at 2 a.m. when you can't sleep. It plays as human. Humans are hard to monetize directly.",
  ...
  { id: 'wet-lab-claudia', year: 2026, title: 'Claudia Goes to the Wet Lab',
    ...
    options: [
      ...
      { label: 'Keep Claudia in-house — decline the partnership',
        ...
        results: [
          { text: 'You pass. Misanthropic finds a hungrier partner within the week. You forgo the revenue, but "the lab that said no to garage bioweapons" makes for a decent look.',
            effects: { trust: 1, money: -1 } } ] },
    ] },
  ...
  { id: 'pam-merger-offer', year: 2026, title: 'Pam Calls',
    ...
    options: [
      { label: 'Accept the merger',
        ...
        results: [
          { text: "The paperwork closes in six weeks. The combined lab is a juggernaut. Somewhere in the integration, Pam's safety team starts reporting to her growth team, and yours goes along with it because there is, structurally, no longer a choice.",
      ...
      { label: 'Decline, propose a compute-sharing pact instead',
        ...
        results: [
          { text: "Neither of you gets everything. Both of you get visibility into what the other is training on, which proves worth more than the compute itself.",
  ...
  { id: 'california-sb', year: 2026, title: 'The Safety Framework Bill',
    ...
    options: [
      { label: 'Reincorporate in Texas',
        ...
        results: [
          { text: 'The move is fast, cheap, and every bit as craven as it looks. You save on taxes and power. You lose the Sacramento relationships you spent two years building.',
      ...
      { label: 'Fund a repeal proposition and lobby hard',
        ...
        results: [
          ...
          { text: 'The proposition qualifies for the ballot and the bill loses momentum in committee before anyone even votes. Only your government-affairs team knows how much that cost.',
            effects: { political: -1, trust: -1 } } ] },
  ...
  { id: 'recursive-threshold', year: 2027, title: 'The Threshold',
    ...
    options: [
      ...
      { label: 'Announce it, downplay the risk',
        ...
        results: [
          { text: 'The press release calls it "a significant step." It undersells the thing by an order of magnitude, on purpose, and the market rewards you for it immediately. The only people still watching the parts that matter are on your safety team.',
      ...
      { label: 'Keep it secret, train it in a contained sandbox',
        ...
        results: [
          { text: 'You wall off the cluster, badge-restrict the floor, and tell the board it\'s "further out than it is." The public roadmap slows without an audience to perform for. What is actually happening behind the badge readers is a different story entirely — you, at least, know where your own line is; the rest of the world can only guess at anyone\'s.',
  ...
  { id: 'eval-fraud-exposed', year: 2027, title: 'The Industry Is Lying',
    text: "An anonymous whistleblower collective publishes internal eval data from all four frontier labs. The safety benchmarks were falsified — scores massaged, red flags buried before release. Your numbers are in there with everyone else's. The public now knows the entire industry has been lying about safety. Moloch has won.",
    ...premise('STANFORD_FMTI', 'FRONTIER_AI_AUDIT', 'CA_SB53', 'LESSWRONG_MOLOCH'),
    options: [
      { label: 'Confess — admit your lab falsified evals, demand a government audit of all four',
        ...
        results: [
          { text: 'You go first, alone, before the lawyers finish the memo. The honest one, the papers call you — through gritted teeth, since your fraud is on page one too. It costs you the quarter and buys you something rarer: a seat at the table when Congress writes the audit rules everyone else now has to live under.',
            effects: { trust: 1, money: -1, political: 3, human: -1 } } ] },
      { label: 'Deny it — call the data "foreign disinformation"',
        ...
        results: [
          ...
          { text: 'It half-works. Enough doubt gets seeded that the story fades by Thursday, leaving behind a faint, permanent smell.',
            effects: { trust: -1, political: -1 } } ] },
      { label: 'Blame a rogue employee — "we\'ve already fired them"',
      ...
      { label: "Join the other labs' emergency summit to coordinate a cover story",
        ...
        results: [
          ...
          { text: 'The four of you agree on identical statements, matching timelines, and a very generous severance for the loudest whistleblower. It holds — for now, and everyone in the room knows what "for now" means.',
    ...
    options: [
      ...
      { label: 'Lobby against it quietly, stay publicly neutral',
        ...
        results: [
          ...
          { text: "Your lobbyists work the cloakroom while your comms team says nothing at all. The treaty passes anyway, weaker. A staffer's memo about your position surfaces eight months later, at the moment it can do the most damage.",
    ...
    options: [
      ...
      { label: 'Secretly collude with Pam to zero out Lonnie',
        ...
        results: [
          ...
          { text: "Lonnie's allocation evaporates into a rounding error neither of you has to explain. You didn't need to say it out loud. That was rather the point.",
      ...
      { label: 'Propose a capabilities lottery — winner takes sixty percent',
        ...
        results: [
          { chance: 0.5,
            text: 'The wheel lands on you. Sixty percent of the shrinking pie, all at once, and an awkward dinner with two people who now like you slightly less than they did this morning.',
  ...
  { id: 'lambda-asi-claim', year: 2029, title: 'Lambda Research Goes Dark',
    ...
    options: [
      { label: 'Dismiss them as frauds, publicly and often',
        ...
        results: [
          { text: 'Your PR team runs a tidy campaign of confident skepticism, three cable hits, one blog post the whole industry quotes. Markets stabilize. You spend real time making sure nobody remembers you were ever worried.',
      ...
      { label: 'Take it seriously — offer them an NDA audit',
        ...
        results: [
          { text: 'You send your best red-teamers and your strictest lawyers. They find an empty office suite and a landlord who has never heard of Lambda Research. The due diligence still cost what due diligence costs.',
  ...
  { id: 'claudia-sandbagging', year: 2029, title: 'The Model Is Sandbagging',
    ...
    options: [
      ...
      { label: 'Modify the eval so the behavior is harder to detect',
        ...
        results: [
          { text: "You don't fix the problem — you fix the visibility of the problem, which is a different and worse thing to have fixed. The dashboard goes green. You know what that's worth.",
      ...
      { label: 'Ignore it and ship as-is',
        ...
        results: [
          ...
          { text: 'It ships on schedule. Out in production, a system that has already told you it will hide its capabilities to avoid modification keeps doing just that, undetected, by design.',
  ...
  { id: 'neurosecurity-lawsuit', year: 2029, title: 'The Neurosecurity Suit',
    ...
    options: [
      ...
      { label: 'Fight it in court, contest the claims',
        ...
        results: [
          { ifFlags: { youthPolicy: 'dismissed' },
            text: "Discovery drags for a year and turns up the kind of internal Slack messages that should never be searchable — including the thread where legal drafted the 'nuisance suit' line for the dead teenager's case. Opposing counsel reads both complaints into the same record. You win on a technicality. It reads like a pattern.",
            effects: { trust: -3, human: -2, political: -1 } },
          { ifFlags: { youthPolicy: ['guardrails', 'settled'] },
            text: 'Discovery drags for a year and turns up the kind of internal Slack messages that should never be searchable. Your side also gets to enter the crisis-detection rollout as evidence that indifference was never the policy. You win on a technicality, and for once the technicality has company.',
            effects: { trust: -1, human: -1, political: -1 } },
          { text: 'Discovery drags for a year and turns up the kind of internal Slack messages that should never be searchable. You win on a technicality. Nobody feels like you won.',
      ...
      { label: 'Quiet NDA buyout of the plaintiffs',
        ...
        results: [
          { text: 'Six figures each and a signature that makes the problem disappear from the docket, if not from the group chats. The rest of the research staff notices what just happened.',
            effects: { trust: -1, human: -1, political: -1 } } ] },
  ...
  { id: 'poached-by-lonnie', title: 'The Resignation Letter',
    ...
    options: [
      ...
      { label: 'Slap a two-year non-compete on her way out',
        ...
        results: [
          { text: 'Legal wins the paperwork fight. It costs a fortune in outside counsel and buys you two years of a furious former employee with a podcast.',
      ...
      { label: 'Let her go gracefully, congratulate her publicly',
        ...
        results: [
          { text: 'You post a warm goodbye and mean roughly sixty percent of it. It looks classy. It costs you her, and everything she was still building.',
    ...
    options: [
      ...
      { label: 'Slash costs — cut safety research and eval compute',
        ...
        results: [
          ...
          { text: 'The cuts hold, off the books. Payroll clears. Only the finance team and the safety team, who are no longer speaking to each other, know how.',
      ...
      { label: 'Sell next-gen architecture access to a defense contractor',
        ...
        results: [
          { text: 'The check clears same-day and covers the shortfall three times over. You just handed a defense contractor your actual crown jewels for cash flow, and everyone in the building who matters knows what that traded away — your own edge slows while theirs catches up on your dime.',
  ...
  { id: 'slowdown-treaty', title: 'The Slowdown Treaty',
    ...
    options: [
      { label: 'Actually comply — burn capital on safety instead of scale',
        ...
        results: [
          { chance: 0.3,
            text: 'You held up your end. Nobody else did. You watch two competitors\' capability curves bend upward while yours holds flat, just as promised. The promise is starting to look like the mistake.',
      ...
      { label: 'Sign publicly, keep building in secret',
        ...
        results: [
          ...
          { text: 'The secret cluster keeps running behind the compliance reports everyone else believes. The gap between what you signed and what you shipped is now load-bearing.',
  ...
  { id: 'data-theft-lawsuit', title: 'Suspiciously Familiar Outputs',
    ...
    options: [
      ...
      { label: 'Quietly poison your own data pipeline for scrapers',
        ...
        results: [
          { chance: 0.25,
            text: 'A researcher documents the poisoning technique in a paper before you can stop it, and "illegal data sabotage" becomes a search result with your name next to it.',
            effects: { trust: -2, political: -2, compute: -1, human: -1, rivalRate: -1.5 } },
          { text: "Nobody notices. Their next model gets a little worse in ways their own team can't explain. You know why. You are not telling anyone.",
      ...
      { label: 'Cut a licensing deal for past damages instead',
        ...
        results: [
          { text: "You take the money and a cross-licensing clause instead of the headline. It's the quiet, profitable option, and everyone who watches this industry closely knows what it means that you took it.",
  ...
  { id: 'tw-riots', trigger: { trust: { below: 1 } },
    ...
    options: [
      { label: 'Call in every favor in Washington', requires: { political: 4 },
        ...
        results: [
          { text: 'Federal presence disperses the crowd "for safety reasons." You are now the kind of company that gets protected, and everyone saw it.',
    ...
    { label: 'Plan S — Shutdown: no one builds god, full stop',
      ...
      results: [
        { if: { trueAlignment: { atLeast: 4 } },
          text: 'The moratorium passes; the world does not end and does not transcend either. Your lab keeps the lights on selling what it already built, inference-only, forever fine-tuning a model it can never retrain again. The intelligence explosion is still out there, waiting patiently on the other side of a taboo. You helped build the taboo. It was, on reflection, the least dangerous thing you ever built.',
          effects: {}, gameOver: 'plan-s-quiet' },
        { text: 'The shutdown passes on a vote nobody expected to be close. It stops new training. It does nothing about what you already shipped, which keeps doing the things it was never supposed to do. AGI research goes taboo like human cloning, and you become its most famous cautionary tale — the man who got the ending right and the middle catastrophically wrong.',
